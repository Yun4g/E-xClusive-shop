  ...
  return (
    <>
        ...
        <main>
          <section className="  h-screen flex items-center  gap-4  z-[1000]    ">
            <div className=" h-full  flex flex-col justify-center  w-full  items-center  md:h-1/2 lg:pt-[100px] z-[1000] ">
              ...
              <button onClick={handleNavigate} className=" bg-red-800 text-white  font-bold w-60 h-16 rounded ">
                 Shop Demo 
     ...
     <CarouselSpacing/>
      ...
      <section className="  border md:h-[80vh] flex flex-col justify-center items-center   bg-slate-950 ">

        

        <div className="   md:h-[70vh] flex flex-col justify-center p-2  items-center lg:w-[49rem] ">
